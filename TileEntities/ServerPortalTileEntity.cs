...
namespace ServerPortals.TileEntities
{
    public class ServerPortalTileEntity : ModTileEntity, IServerPortal
    {
        ...
        public override bool IsTileValidForEntity(int i, int j)
        {
            ...
            return tile.HasTile && ServerPortalsMod.PortalTileTypes.Contains(tile.TileType) && tile.TileFrameX == 0 && tile.TileFrameY == 0;
        }
        ...
        public override int Hook_AfterPlacement(int i, int j, int type, int style, int direction, int alternate)
        {
            ...
            if (Main.netMode == 1)
            {
                ...
                ServerPortalsMod.ClientSendPortalPlacement(ServerTransferCreationMenu.GetData(), i, j);
                return -1;
            }
